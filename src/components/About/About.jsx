      ...
      <div className="max-w-7xl mx-auto py-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-around">
          <div className="bg-white text-gray-800 p-6 m-4 rounded-xl shadow-md max-w-sm text-center">
            <img src="/images/founders/avatar.png" alt="Raghav Anand" className="w-32 h-32 rounded-full mx-auto mb-4" />
          ...
          <div className="bg-white text-gray-800 p-6 m-4 rounded-xl shadow-md max-w-sm text-center">
            <img src="images/founders/pfp.jpg" alt="Harshit Bedi" className="w-32 h-32 rounded-full mx-auto mb-4" />
